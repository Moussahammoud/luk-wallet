(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function e(e,t){let n=e/100;try{return new Intl.NumberFormat(void 0,{style:`currency`,currency:t,maximumFractionDigits:2}).format(n)}catch{return`${t} ${n.toFixed(2)}`}}function t(e){let t=e.trim();if(!t)return null;let n=t.replace(/,/g,``),r=Number(n);if(!Number.isFinite(r))return null;let i=Math.round(r*100);return Number.isFinite(i)?i:null}function n(){let e=new Date;return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function r(e){return e.slice(0,7)}function i(){let e=new Date;return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}`}function a(e){let t=Math.random().toString(16).slice(2);return`${e}_${Date.now().toString(16)}_${t}`}var o=[],s=`expense_tracker_v1`;function c(){return{version:1,currency:`USD`,openingBalanceCents:0,categories:[...o],incomeByMonth:{},incomes:[],expenses:[],pending:[],budgets:[]}}function l(e){return typeof e==`object`&&!!e}function u(e){return typeof e==`string`&&/^\d{4}-\d{2}-\d{2}$/.test(e)}function d(e){return e.trim()}function f(e){let t=[];if(!Array.isArray(e))return t;for(let n of e){if(!l(n))continue;let e=n.category,r=n.monthlyCents;if(typeof e!=`string`||typeof r!=`number`||!Number.isFinite(r))continue;let i=d(e);i&&t.push({category:i,monthlyCents:Math.max(0,Math.round(r))})}return t}function p(e){let t=[];if(!Array.isArray(e))return t;for(let n of e){if(!l(n))continue;let e=n.id,r=n.date,i=n.category,a=n.amountCents,o=n.note,s=n.createdAt;if(typeof e!=`string`||e.length<3||!u(r)||typeof i!=`string`||typeof a!=`number`||!Number.isFinite(a)||typeof o!=`string`||typeof s!=`number`||!Number.isFinite(s))continue;let c=d(i);c&&t.push({id:e,date:r,category:c,amountCents:Math.round(a),note:o,createdAt:s})}return t.sort((e,t)=>e.date===t.date?t.createdAt-e.createdAt:t.date.localeCompare(e.date)),t}function m(e){let t=[];if(!Array.isArray(e))return t;for(let n of e){if(!l(n))continue;let e=n.id,r=n.date,i=n.amountCents,a=n.note,o=n.createdAt;typeof e!=`string`||e.length<3||u(r)&&(typeof i!=`number`||!Number.isFinite(i)||typeof a==`string`&&(typeof o!=`number`||!Number.isFinite(o)||t.push({id:e,date:r,amountCents:Math.max(0,Math.round(i)),note:a.trim(),createdAt:o})))}return t.sort((e,t)=>e.date===t.date?t.createdAt-e.createdAt:t.date.localeCompare(e.date)),t}function h(e){let t=[];if(!Array.isArray(e))return t;for(let n of e){if(!l(n))continue;let e=n.id,r=n.person,i=n.totalCents,a=n.paidCents,o=n.note,s=n.createdAt,c=n.closedAt;if(typeof e!=`string`||e.length<3||typeof r!=`string`||typeof i!=`number`||!Number.isFinite(i)||typeof a!=`number`||!Number.isFinite(a)||typeof o!=`string`||typeof s!=`number`||!Number.isFinite(s)||!(c===null||typeof c==`number`&&Number.isFinite(c)))continue;let u=r.trim();if(!u)continue;let d=Math.max(0,Math.round(i)),f=Math.max(0,Math.round(a)),p=f>=d&&d>0?typeof c==`number`?c:Date.now():null;t.push({id:e,person:u,totalCents:d,paidCents:Math.min(f,d),note:o.trim(),createdAt:s,closedAt:p})}return t.sort((e,t)=>e.closedAt===t.closedAt?t.createdAt-e.createdAt:e.closedAt===null?-1:1),t}function g(e){if(!Array.isArray(e))return[];let t=[];for(let n of e){if(typeof n!=`string`)continue;let e=d(n);e&&e!==`General`&&(t.includes(e)||t.push(e))}return t}function _(e){if(!l(e))return{};let t={};for(let[n,r]of Object.entries(e))/^\d{4}-\d{2}$/.test(n)&&(typeof r!=`number`||!Number.isFinite(r)||(t[n]=Math.max(0,Math.round(r))));return t}function v(e,t){let n=[],r=e=>{let t=d(e);t&&t!==`General`&&(n.includes(t)||n.push(t))};for(let t of e)r(t);for(let e of t)r(e);return n}function y(){try{let e=localStorage.getItem(s);if(!e)return c();let t=JSON.parse(e);if(!l(t))return c();let n=typeof t.currency==`string`&&t.currency?t.currency:`USD`,r=t.openingBalanceCents,i=typeof r==`number`&&Number.isFinite(r)?Math.round(r):0,a=p(t.expenses),o=m(t.incomes),u=f(t.budgets);return{version:1,currency:n,openingBalanceCents:i,categories:v(g(t.categories),v(u.map(e=>e.category),a.map(e=>e.category))),incomeByMonth:_(t.incomeByMonth),incomes:o,expenses:a,pending:h(t.pending),budgets:u}}catch{return c()}}function b(e){localStorage.setItem(s,JSON.stringify(e))}function ee(){localStorage.removeItem(s)}function x(e,t){let n=d(t);return!n||n===`General`||e.categories.includes(n)?e:{...e,categories:[...e.categories,n]}}function te(e,t){return{...e,openingBalanceCents:Math.round(t)}}function S(e,t){let n=d(t.category);if(!n)return e;let r={id:a(`exp`),date:t.date,category:n,amountCents:Math.round(t.amountCents),note:t.note.trim(),createdAt:Date.now()},i=x({...e,expenses:[r,...e.expenses]},n);return i.expenses.sort((e,t)=>e.date===t.date?t.createdAt-e.createdAt:t.date.localeCompare(e.date)),i}function C(e,t){let n=Math.max(0,Math.round(t.amountCents));if(n<=0)return e;let r=[{id:a(`inc`),date:t.date,amountCents:n,note:t.note.trim(),createdAt:Date.now()},...e.incomes];return r.sort((e,t)=>e.date===t.date?t.createdAt-e.createdAt:t.date.localeCompare(e.date)),{...e,incomes:r}}function ne(e,t,n){let r=e.incomes.map(e=>e.id===t?{...e,...n.date?{date:n.date}:{},...typeof n.amountCents==`number`?{amountCents:Math.max(0,Math.round(n.amountCents))}:{},...typeof n.note==`string`?{note:n.note.trim()}:{}}:e).filter(e=>e.amountCents>0);return r.sort((e,t)=>e.date===t.date?t.createdAt-e.createdAt:t.date.localeCompare(e.date)),{...e,incomes:r}}function re(e,t){return{...e,incomes:e.incomes.filter(e=>e.id!==t)}}function ie(e,t,n){let r=e;if(typeof n.category==`string`){let e=d(n.category);e&&(r=x(r,e))}let i=e.expenses.map(e=>e.id===t?{...e,...n.date?{date:n.date}:{},...typeof n.category==`string`&&d(n.category)?{category:d(n.category)}:{},...typeof n.amountCents==`number`?{amountCents:Math.round(n.amountCents)}:{},...typeof n.note==`string`?{note:n.note.trim()}:{}}:e);return i.sort((e,t)=>e.date===t.date?t.createdAt-e.createdAt:t.date.localeCompare(e.date)),{...r,expenses:i}}function ae(e,t){return{...e,expenses:e.expenses.filter(e=>e.id!==t)}}function oe(e,t){let n=t.person.trim();if(!n)return e;let r=Math.max(0,Math.round(t.totalCents)),i=Math.max(0,Math.round(t.paidCents??0));if(r<=0)return e;let o=Math.min(i,r),s=o>=r?Date.now():null,c={id:a(`pend`),person:n,totalCents:r,paidCents:o,note:(t.note??``).trim(),createdAt:Date.now(),closedAt:s};return{...e,pending:[c,...e.pending]}}function w(e,t,n){let r=Math.max(0,Math.round(n));if(r<=0)return e;let i=e.pending.map(e=>{if(e.id!==t)return e;let n=Math.min(e.totalCents,e.paidCents+r);return{...e,paidCents:n,closedAt:n>=e.totalCents?e.closedAt??Date.now():null}});return{...e,pending:i}}function T(e,t){return{...e,pending:e.pending.filter(e=>e.id!==t)}}function se(e,t,n){let r=e.pending.map(e=>{if(e.id!==t)return e;let r=typeof n.person==`string`?n.person.trim():e.person,i=typeof n.totalCents==`number`?Math.max(0,Math.round(n.totalCents)):e.totalCents,a=typeof n.paidCents==`number`?Math.max(0,Math.round(n.paidCents)):e.paidCents,o=Math.min(a,i),s=typeof n.note==`string`?n.note.trim():e.note,c=i>0&&o>=i?e.closedAt??Date.now():null;return{...e,person:r||e.person,totalCents:i,paidCents:o,note:s,closedAt:c}});return{...e,pending:r}}function ce(e,t){return e.expenses.filter(e=>r(e.date)===t)}function E(e,t){return e.incomes.filter(e=>r(e.date)===t)}function D(e){return e.reduce((e,t)=>e+t.amountCents,0)}function O(e){return e.reduce((e,t)=>e+t.amountCents,0)}var k=`expense_auth_v1`,A=`expense_saved_creds_v1`;function j(){try{let e=localStorage.getItem(k);if(!e)return{users:[],currentUser:null};let t=JSON.parse(e);return{users:Array.isArray(t.users)?t.users.filter(e=>typeof e==`object`&&!!e&&typeof e.username==`string`&&typeof e.password==`string`&&e.username.trim().length>0):[],currentUser:typeof t.currentUser==`string`&&t.currentUser.trim()?t.currentUser:null}}catch{return{users:[],currentUser:null}}}function M(e){localStorage.setItem(k,JSON.stringify(e))}function N(){try{let e=localStorage.getItem(A);if(!e)return null;let t=JSON.parse(e);if(typeof t.username!=`string`||typeof t.password!=`string`)return null;let n=t.username.trim(),r=t.password;return!n||!r?null:{username:n,password:r}}catch{return null}}function P(e,t){localStorage.setItem(A,JSON.stringify({username:e.trim(),password:t}))}function F(){localStorage.removeItem(A)}function I(e,t){let n=e.trim(),r=t.trim();if(!n||!r)return!1;let i=j(),a=i.users.findIndex(e=>e.username.toLowerCase()===n.toLowerCase());return a<0?!1:(i.users[a]={...i.users[a],password:r},M(i),!0)}function L(e){return e.trim()}function R(e){return e.replace(/[&<>"']/g,e=>{switch(e){case`&`:return`&amp;`;case`<`:return`&lt;`;case`>`:return`&gt;`;case`"`:return`&quot;`;case`'`:return`&#39;`;default:return e}})}function z(e,t){return e.expenses.find(e=>e.id===t)}function B(e,t){return e.pending.find(e=>e.id===t)}function V(e,t){return e.incomes.find(e=>e.id===t)}function H(e,t){let n=new Blob([t],{type:`application/json;charset=utf-8`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=e,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}function U(e){return new Promise((t,n)=>{let r=new FileReader;r.onerror=()=>n(Error(`Failed to read file`)),r.onload=()=>t(String(r.result??``)),r.readAsText(e)})}function W(e,t){let n=e.querySelector(`[data-toast]`);n&&(n.textContent=t,n.dataset.show=`true`,window.setTimeout(()=>{n.dataset.show=`false`},2400))}function le(){return`
  ...
  `}function de(t,n,r){let i=t.querySelector(`[data-category-list]`);i&&(i.innerHTML=n.categories.map(e=>`<option value="${R(e)}"></option>`).join(``));let a=ce(n,r.ym),o=E(n,r.ym),s=r.query.trim().toLowerCase(),c=a.filter(e=>{let t=r.category===`All`?!0:e.category===r.category,n=s?e.note.toLowerCase().includes(s):!0;return t&&n}),l=O(o),u=D(a),d=l-u,f=O(n.incomes),p=D(n.expenses),m=n.openingBalanceCents+f-p,h=n.pending.filter(e=>e.closedAt===null),g=h.reduce((e,t)=>e+(t.totalCents-t.paidCents),0),_=c.length===0?``:`<div class="historyCards">
      ...
      <div class="tableWrap" aria-label="Expense history table (scrollable)">
        <div class="table">
          ...
          ${c.map(t=>{let r=t.note||`—`;return`<div class="table__row">
                ...
                <div>${R(t.category)}</div>
                <div class="right mono">${e(t.amountCents,n.currency)}</div>
                <div class="noteCell" title="${R(r)}">
                  <div class="noteCell__note">${R(r)}</div>
                </div>
              ...
              ${o.map(t=>`<article class="inCard">
                    <div class="inCard__top">
                      <div class="inCard__left">
                        <div class="inCard__note">${R(t.note||`—`)}</div>
        ...
        <div class="historyHead__filters">
          <label class="field">
            ...
            <select class="input input--sm" data-filter-category>
              ...
              ${n.categories.map(e=>`<option value="${R(e)}" ${r.category===e?`selected`:``}>${R(e)}</option>`).join(``)}
            </select>
          </label>
          <label class="field">
            <span class="field__label">Search note</span>
            <input class="input input--sm" data-filter-q value="${R(r.query)}" placeholder="e.g. rent" />
          </label>
        </div>
      </div>
      ${_}
    ...
    <section class="panel">
      ...
      ${h.length===0?`<div class="empty">No pending items. Add one when someone owes you money.</div>`:`<div class="pendingList">
              ${h.map(t=>{let r=Math.max(0,t.totalCents-t.paidCents),i=t.note?`<span class="pending__noteInline muted">• ${R(t.note)}</span>`:``;return`<article class="pending">
                    <div class="pending__row">
                      <div>
                        <div class="pending__headLine">
                          <span class="pending__person">${R(t.person)}</span>
                          ${i}
                        </div>
  ...
  `)}function G(e,t){let n=e.querySelector(`[data-expense-modal]`);n&&(n.dataset.open=t?`true`:`false`,n.setAttribute(`aria-hidden`,t?`false`:`true`))}function K(e,t){let n=e.querySelector(`[data-income-modal]`);n&&(n.dataset.open=t?`true`:`false`,n.setAttribute(`aria-hidden`,t?`false`:`true`))}function q(e){let t=e.querySelector(`[data-income-form]`),r=e.querySelector(`[data-income-modal-title]`);if(!t||!r)return;let i=t.elements.namedItem(`amount`),a=t.elements.namedItem(`date`),o=t.elements.namedItem(`note`);!i||!a||!o||(r.textContent=`Add IN (money received)`,i.value=``,a.value=n(),o.value=``)}function fe(e,t,n){let r=e.querySelector(`[data-income-form]`),i=e.querySelector(`[data-income-modal-title]`);if(!r||!i)return;let a=r.elements.namedItem(`amount`),o=r.elements.namedItem(`date`),s=r.elements.namedItem(`note`);if(!a||!o||!s)return;if(!n){q(e);return}let c=V(t,n);if(!c){q(e);return}i.textContent=`Edit IN entry`,a.value=(c.amountCents/100).toFixed(2),o.value=c.date,s.value=c.note}function J(e,t,r){let i=e.querySelector(`[data-expense-form]`),a=e.querySelector(`[data-expense-modal-title]`);if(!i||!a)return;let o=!!r.editingId;a.textContent=o?`Edit expense`:`Add expense`;let s=i.elements.namedItem(`amount`),c=i.elements.namedItem(`date`),l=i.elements.namedItem(`category`),u=i.elements.namedItem(`note`);if(!(!s||!c||!l||!u))if(o){let e=z(t,r.editingId);if(!e){r.editingId=null,s.value=``,c.value=n(),l.value=t.categories[0]??``,u.value=``;return}s.value=(e.amountCents/100).toFixed(2),c.value=e.date,l.value=e.category,u.value=e.note}else s.value=``,c.value=n(),l.value=t.expenses[0]?.category??t.categories[0]??``,u.value=``}function Y(e,t){let n=e.querySelector(`[data-pending-modal]`);n&&(n.dataset.open=t?`true`:`false`,n.setAttribute(`aria-hidden`,t?`false`:`true`))}function X(e,t){let n=e.querySelector(`[data-pay-modal]`);n&&(n.dataset.open=t?`true`:`false`,n.setAttribute(`aria-hidden`,t?`false`:`true`))}function pe(e){let t=e.querySelector(`[data-pay-form]`);if(!t)return;let n=t.elements.namedItem(`amount`);n&&(n.value=``)}function Z(e,t,n){let r=e.querySelector(`[data-pending-form]`),i=e.querySelector(`[data-pending-modal-title]`);if(!r||!i)return;let a=r.elements.namedItem(`person`),o=r.elements.namedItem(`total`),s=r.elements.namedItem(`paid`),c=r.elements.namedItem(`note`);if(!a||!o||!s||!c)return;if(!n){i.textContent=`Add pending (owed to you)`,a.value=``,o.value=``,s.value=``,c.value=``;return}let l=B(t,n);if(!l){i.textContent=`Add pending (owed to you)`,a.value=``,o.value=``,s.value=``,c.value=``;return}i.textContent=`Edit pending`,a.value=l.person,o.value=(l.totalCents/100).toFixed(2),s.value=(l.paidCents/100).toFixed(2),c.value=l.note}function Q(n){let r=j();if(!r.currentUser){n.innerHTML=ue();let e=n.querySelector(`[data-auth-form]`),t=N();if(e&&t){let n=e.elements.namedItem(`username`),r=e.elements.namedItem(`password`),i=e.elements.namedItem(`savePassword`);n&&(n.value=t.username),r&&(r.value=t.password),i&&(i.checked=!0)}e?.addEventListener(`submit`,t=>{t.preventDefault();let i=t.submitter?.dataset.authAction,a=e.elements.namedItem(`username`),o=e.elements.namedItem(`password`),s=e.elements.namedItem(`savePassword`);if(!a||!o||!i)return;let c=a.value.trim(),l=o.value.trim(),u=!!s?.checked;if(!c||!l){alert(`Enter username and password`);return}r=j();let d=r.users.find(e=>e.username.toLowerCase()===c.toLowerCase());if(i===`register`){if(d){alert(`Username already exists`);return}r.users.push({username:c,password:l}),r.currentUser=c,M(r),u?P(c,l):F(),Q(n);return}if(!d||d.password!==l){alert(`Invalid username or password`);return}r.currentUser=d.username,M(r),u?P(d.username,l):F(),Q(n)}),n.querySelector(`[data-auth-reset]`)?.addEventListener(`click`,()=>{let e=prompt(`Enter your username to reset password:`);if(!e)return;let t=prompt(`Enter a new password:`);if(!t)return;if(!I(e,t)){alert(`Username not found`);return}let n=N();n&&n.username.toLowerCase()===e.trim().toLowerCase()&&P(e.trim(),t.trim()),alert(`Password reset successful. You can login now.`)});return}n.innerHTML=le();let a=y(),o={ym:i(),query:``,category:`All`,editingId:null,editingIncomeId:null,isExpenseModalOpen:!1,isIncomeModalOpen:!1,isPendingModalOpen:!1,pendingEditId:null,isPayModalOpen:!1,pendingPayId:null},s=n.querySelector(`[data-month]`);s&&(s.value=o.ym);let c=()=>de(n,a,o);c();let l=null,u=()=>{l!==null&&window.clearTimeout(l);let e=document.activeElement,t=e instanceof HTMLInputElement&&e.matches(`[data-filter-q]`),r=t&&e.selectionStart!==null?e.selectionStart:null;l=window.setTimeout(()=>{if(c(),l=null,t){let e=n.querySelector(`[data-filter-q]`);if(e){e.focus();let t=r??e.value.length;e.setSelectionRange(t,t)}}},120)},d=n.querySelector(`[data-menu]`),f=n.querySelector(`[data-menu-panel]`),p=()=>{f&&(f.hidden=!0)};d?.addEventListener(`click`,()=>{f&&(f.hidden=!f.hidden)}),document.addEventListener(`click`,e=>{let t=e.target;t&&(t.closest(`[data-menu]`)||t.closest(`[data-menu-panel]`)||p())}),s?.addEventListener(`change`,()=>{let e=s.value;/^\d{4}-\d{2}$/.test(e)&&(o.ym=e,c())}),n.addEventListener(`click`,async e=>{let t=e.target;if(!t)return;if(t.closest(`[data-open-expense]`)){o.editingId=null,o.isExpenseModalOpen=!0,G(n,!0),J(n,a,o),p();return}if(t.closest(`[data-open-income]`)){o.editingIncomeId=null,o.isIncomeModalOpen=!0,K(n,!0),q(n),p();return}if(t.closest(`[data-close-expense]`)){o.editingId=null,o.isExpenseModalOpen=!1,G(n,!1),p();return}if(t.closest(`[data-close-income]`)){o.editingIncomeId=null,o.isIncomeModalOpen=!1,K(n,!1),p();return}let r=t.closest(`[data-in-edit]`);if(r&&r.getAttribute(`data-in-edit`)){let e=r.getAttribute(`data-in-edit`);o.editingIncomeId=e,o.isIncomeModalOpen=!0,K(n,!0),fe(n,a,e),p();return}let i=t.closest(`[data-in-del]`);if(i&&i.getAttribute(`data-in-del`)){let e=i.getAttribute(`data-in-del`);if(!confirm(`Delete this IN entry?`))return;a=re(a,e),b(a),c(),W(n,`IN deleted`),p();return}let l=t.closest(`[data-edit]`);if(l?.dataset.edit){o.editingId=l.dataset.edit,o.isExpenseModalOpen=!0,G(n,!0),J(n,a,o),p();return}let u=t.closest(`[data-del]`);if(u?.dataset.del){let e=u.dataset.del;if(!confirm(`Delete this expense?`))return;a=ae(a,e),b(a),c(),W(n,`Expense deleted`),p();return}if(t.closest(`[data-export]`)){H(`expense-tracker-${new Date().toISOString().slice(0,10)}.json`,JSON.stringify(a,null,2)),p(),W(n,`Exported`);return}if(t.closest(`[data-logout]`)){let e=j();e.currentUser=null,M(e),Q(n);return}if(t.closest(`[data-open-pending]`)){o.isPendingModalOpen=!0,o.pendingEditId=null,Y(n,!0),Z(n,a,null),p();return}if(t.closest(`[data-close-pending]`)){o.isPendingModalOpen=!1,o.pendingEditId=null,Y(n,!1),p();return}if(t.closest(`[data-close-pay]`)){o.isPayModalOpen=!1,o.pendingPayId=null,X(n,!1),p();return}let d=t.closest(`[data-pend-edit]`);if(d&&d.getAttribute(`data-pend-edit`)){let e=d.getAttribute(`data-pend-edit`);o.isPendingModalOpen=!0,o.pendingEditId=e,Y(n,!0),Z(n,a,e),p();return}let f=t.closest(`[data-pend-pay]`);if(f&&f.getAttribute(`data-pend-pay`)){let e=f.getAttribute(`data-pend-pay`);o.isPayModalOpen=!0,o.pendingPayId=e,X(n,!0),pe(n);return}let m=t.closest(`[data-pend-del]`);if(m&&m.getAttribute(`data-pend-del`)){let e=m.getAttribute(`data-pend-del`);if(!confirm(`Delete this pending item?`))return;a=T(a,e),b(a),c(),W(n,`Pending deleted`);return}if(t.closest(`[data-reset]`)){if(!confirm(`This will erase all app data (income, IN, expenses, pending, budgets). Continue?`))return;ee(),a=y(),o={...o,query:``,category:`All`,editingId:null,editingIncomeId:null},s&&(s.value=o.ym),G(n,!1),K(n,!1),Y(n,!1),X(n,!1),c(),p(),W(n,`Reset complete`);return}if(t.closest(`[data-import]`)){p();return}}),n.addEventListener(`input`,r=>{let i=r.target;if(!i)return;let s=i.closest(`[data-opening-balance]`);if(s){let r=s.value.trim(),i=r===``?0:t(r);if(i===null)return;a=te(a,i),b(a);let o=n.querySelector(`[data-current-money-display]`);if(o){let t=a.openingBalanceCents+O(a.incomes)-D(a.expenses);o.textContent=e(t,a.currency),o.classList.toggle(`is-neg`,t<0)}return}let l=i.closest(`[data-filter-q]`);if(l){o.query=l.value,u();return}let d=i.closest(`[data-filter-category]`);if(d){let e=d.value;o.category=e===`All`?`All`:e,c();return}});let m=n.querySelector(`[data-import]`);m?.addEventListener(`change`,async()=>{let e=m.files?.[0];if(e)try{let t=await U(e),r=JSON.parse(t);localStorage.setItem(`expense_tracker_v1`,JSON.stringify(r)),a=y(),c(),W(n,`Imported`)}catch{W(n,`Import failed (invalid JSON)`)}finally{m.value=``}});let h=n.querySelector(`[data-expense-form]`);h?.addEventListener(`submit`,e=>{if(e.preventDefault(),!h)return;let r=h.elements.namedItem(`amount`),i=h.elements.namedItem(`date`),s=h.elements.namedItem(`category`),l=h.elements.namedItem(`note`);if(!r||!i||!s||!l)return;let u=r.value.trim();if(!u){W(n,`Amount is required`);return}let d=t(u),f=i.value,p=L(s.value),m=l.value;if(d===null||d<=0){W(n,`Enter an amount like 50 or 50.00`);return}if(!/^\d{4}-\d{2}-\d{2}$/.test(f)){W(n,`Pick a valid date`);return}o.editingId?(a=ie(a,o.editingId,{amountCents:d,date:f,category:p,note:m}),W(n,`Expense updated`)):(a=S(a,{amountCents:d,date:f,category:p,note:m}),W(n,`Expense added`)),b(a),o.editingId=null,o.isExpenseModalOpen=!1,G(n,!1),c()});let g=n.querySelector(`[data-pending-form]`);g?.addEventListener(`submit`,e=>{if(e.preventDefault(),!g)return;let r=g.elements.namedItem(`person`),i=g.elements.namedItem(`total`),s=g.elements.namedItem(`paid`),l=g.elements.namedItem(`note`);if(!r||!i||!s||!l)return;let u=r.value.trim(),d=t(i.value),f=s.value.trim(),p=f===``?0:t(f),m=l.value;if(!u){W(n,`Enter a person`);return}if(d===null||d<=0){W(n,`Enter a valid total`);return}if(p===null||p<0){W(n,`Enter a valid paid amount`);return}a=o.pendingEditId?se(a,o.pendingEditId,{person:u,totalCents:d,paidCents:p,note:m}):oe(a,{person:u,totalCents:d,paidCents:p,note:m}),b(a),o.isPendingModalOpen=!1,o.pendingEditId=null,Y(n,!1),g.reset(),c(),W(n,`Saved`)});let _=n.querySelector(`[data-pay-form]`);_?.addEventListener(`submit`,e=>{if(e.preventDefault(),!_)return;let r=_.elements.namedItem(`amount`);if(!r)return;let i=r.value.trim();if(!i){W(n,`Amount is required`);return}let s=t(i);if(s===null||s<=0){W(n,`Enter an amount like 50 or 50.00`);return}o.pendingPayId&&(a=w(a,o.pendingPayId,s),b(a),o.isPayModalOpen=!1,o.pendingPayId=null,X(n,!1),_.reset(),c(),W(n,`Payment recorded`))});let v=n.querySelector(`[data-income-form]`);v?.addEventListener(`submit`,e=>{if(e.preventDefault(),!v)return;let r=v.elements.namedItem(`amount`),i=v.elements.namedItem(`date`),s=v.elements.namedItem(`note`);if(!r||!i||!s)return;let l=r.value.trim();if(!l){W(n,`Amount is required`);return}let u=t(l),d=i.value,f=s.value;if(u===null||u<=0){W(n,`Enter an amount like 50 or 50.00`);return}if(!/^\d{4}-\d{2}-\d{2}$/.test(d)){W(n,`Pick a valid date`);return}o.editingIncomeId?(a=ne(a,o.editingIncomeId,{amountCents:u,date:d,note:f}),W(n,`IN updated`)):(a=C(a,{amountCents:u,date:d,note:f}),W(n,`IN added`)),b(a),o.editingIncomeId=null,o.isIncomeModalOpen=!1,K(n,!1),v.reset(),c()})}var $=document.querySelector(`#app`);if(!$)throw Error(`Missing #app element`);Q($),`serviceWorker`in navigator&&window.addEventListener(`load`,()=>{navigator.serviceWorker.register(`/luk-wallet/sw.js`).catch(()=>{})});